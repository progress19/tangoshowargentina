                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mask_fecha" name="fecha_inicio" id="fecha_inicio" value="">
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mask_fecha" name="fecha_vencimiento" id="fecha_vencimiento" value="">
                            </div>
                        </div>
                        <div class="col">
...
$(document).ready(function ()
{
    $('#form-save').on('submit', function (e)
    {
        ...
        hideAlerts();
        var request = $.ajax({
            url: '<?= route('back.admin.event.store')?>',
            type: "POST",
            data: $(this).serialize()
        });
