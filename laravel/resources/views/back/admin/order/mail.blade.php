                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td style="padding: 25px 0 0 0; color: #1F0600; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px;">
                                                                    ...
                                                                    @lang('HOTEL') + @lang('ADDRESS'): {{$orden->hotel}}<br />
                                                                    @lang('SHOW DATE'): {{$orden->fecha->format('d/m/Y')}}<br />
                                                                    @lang('SHOW ADDRESS'): {{$orden->espectaculo->casa->direccion}}<br />
                                                                    @lang('NUMBER OF PEOPLE'): {{$orden->cantidad}}<br />
                                                                    @lang('TRANSFER TYPE'): {{$orden->tipo_traslado}}<br />
                                                                    @lang('TRANSFER') (@lang('PER PERSON')): USD {{$orden->precio_traslado}}<br />
                                                                    @lang('SUBTOTAL') @lang('TRANSFER'): USD {{$orden->total_traslado}}<br />
                                                                    @lang('SHOW') (@lang('PER PERSON')): USD {{$orden->precio_show}}<br />
                                                                    @lang('SUBTOTAL') @lang('SHOW'): USD {{$orden->total_show}}<br />
