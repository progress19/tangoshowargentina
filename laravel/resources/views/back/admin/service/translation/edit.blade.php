...
@section('title', __('EDIT TRANSLATION') . ': ' . $servicio->denominacion . ' - ' . $lang)
@section('styles')
@endsection
@section('content')
<div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" value="{{$servicio->denominacion}}" disabled>
                            </div>
                        </div>
                        <div class="col">
                            <label>@lang('NAME')</label>
...
$(document).ready(function ()
{
    $('#form-save').on('submit', function (e)
    {
        ...
        hideAlerts();
        var request = $.ajax({
            url: '<?= route('back.admin.service.translation.update')?>',
            type: "POST",
            data: $(this).serialize(),
        });
