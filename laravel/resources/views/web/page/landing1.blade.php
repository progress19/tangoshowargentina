...
<body>
    ...
    <main role="main" style="width: 100% !important">
        <section class="section-landing p-5"
            style="background-color: #000; text-align: center; border-bottom: 1px solid #333">
        ...
        <section class="section-landing">
            ...
            <a href="https://www.michelangeloweb.com" target="_blank"><img
                    src="{{ asset('/web/img/landing1/michelangelo.jpg') }}" class="img-fluid-custom"></a>
            <a href="http://www.laventanaweb.com" target="_blank"><img
                    src="{{ asset('/web/img/landing1/laventana.jpg') }}" class="img-fluid-custom"></a>
            <a href="http://www.galatango.com" target="_blank"><img src="{{ asset('/web/img/landing1/galatango.jpg') }}"
                    class="img-fluid-custom"></a>
            <a href="http://www.aljibetango.com" target="_blank"><img
                    src="{{ asset('/web/img/landing1/aljibetango.jpg') }}" class="img-fluid-custom"></a>
        ...
        <section class="section-landing">
            ...
            <div class="row no-gutters">
                <div class="col-4">
                    <a href="https://laventanaweb.com/estudio" target="_blank"><img
                            src="{{ asset('/web/img/landing1/escuela-1.jpg') }}" class="img-fluid-custom"></a>
                </div>
                <div class="col-4">
                    <a href="https://laventanaweb.com/cava" target="_blank"><img
                            src="{{ asset('/web/img/landing1/cava-1.jpg') }}" class="img-fluid-custom"></a>
                </div>
                <div class="col-4">
                    <a href="https://laventanaweb.com/terraza" target="_blank"><img
                            src="{{ asset('/web/img/landing1/terraza-2.jpg') }}" class="img-fluid-custom"></a>
                </div>
            </div>
        </section>
        <section class="p-5 text-center" style="background-color: #000; color: white !important">
            ...
            <br>
            <br>
            <i class="fas fa-2x fa-envelope"></i><br><a href="mailto:info@tangoshowargentina.com"
                style="color: white !important">info@tangoshowargentina.com</a>
        </section>
