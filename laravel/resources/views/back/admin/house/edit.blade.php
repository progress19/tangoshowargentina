...
@section('title', __('EDIT TANGO HOUSE'))
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-save">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" id="destacado" name="destacado">
                                    <option value="1" {{ $casa->destacado == 1 ? 'selected' : '' }}>@lang('YES')</option>
                                    <option value="0" {{ $casa->destacado == 0 ? 'selected' : '' }}>@lang('NO')</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mask_lat_long" name="latitud" id="latitud" value="{{ $casa->latitud }}">
                            </div>
                        </div>
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control mask_lat_long" name="longitud" id="longitud" value="{{ $casa->longitud }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" id="rating" name="rating">
                                    <option value="4" {{ $casa->rating == 4 ? 'selected' : '' }}>4</option>
                                    <option value="4.5" {{ $casa->rating == '4.5' ? 'selected' : '' }}>4.5</option>
                                    <option value="5" {{ $casa->rating == 5 ? 'selected' : '' }}>5</option>
                                </select>
                            </div>
                        </div>
                        <div class="col">
                    ...
                    <textarea class="form-control" id="descripcion" name="descripcion">{{ $casa->descripcion }}</textarea>
...
<!-- Modal logo -->
@include('back.admin.house.modals.logo')
<!-- Modal pass -->
@include('back.admin.house.modals.password')
@endsection
@section('scripts')
...
$(document).ready(function ()
{
    $('#form-save').on('submit', function (e)
    {
        ...
        hideAlerts();
        var request = $.ajax({
            url: '<?= route('back.admin.house.update', $casa->id)?>',
            type: "POST",
            data: $(this).serialize()
        });
...
$('#form-logo').on('submit', function (e)
{
    ...
    var request = $.ajax({
        url: '<?= route('back.admin.house.logo.save')?>',
        type: "POST",
        processData: false,
        contentType: false,
        data: formData
...
$('#form-password').on('submit', function (e)
{
    ...
    hideAlerts();
    var request = $.ajax({
        url: '<?= route('back.admin.house.password.save')?>',
        type: "POST",
        data: $(this).serialize()
    });
    handleRequestDone(request);
